...
class AzkarDetailsScreen extends StatefulWidget {
  final AllAzkar zekr;
  const AzkarDetailsScreen({super.key, required this.zekr});
...
class _AzkarDetailsScreenState extends State<AzkarDetailsScreen> {
  ...
  void initState() {
    super.initState();
    counters = widget.zekr.azkarList.map((item) {
        ...
        child: Padding(
          ...
          child: SizedBox(
            child: ListView.builder(
              ...
              itemCount: widget.zekr.azkarList.length,
              itemBuilder: (context, index) {
                final item = widget.zekr.azkarList[index];
